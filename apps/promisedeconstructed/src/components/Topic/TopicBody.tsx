				...
				<article className="text-purple-1 my-2.5 flex flex-col gap-[5px] rounded-[10px] bg-white/40 p-[15px]">
					...
					<ul className="ml-[2ch] list-outside list-disc">
						...
						<li>
							...
							ทีมงานได้อัปเดตข้อมูลงบประมาณและแหล่งที่มาของงบประมาณที่ตรงกันระหว่างเอกสารนโยบายและเว็บไซต์พรรค
							โดยแสดงด้วย<span className="text-green-1">ตัวอักษรสีเขียว</span>
						</li>
					</ul>
					<Link
